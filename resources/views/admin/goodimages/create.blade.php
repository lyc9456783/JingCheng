...
<div class="page-content">
    <div class="content">
        ...
        <hr>
        <form class=" layui-form-pane" action="/admin/goodimages/store" method="post"  enctype="multipart/form-data">
        {{ csrf_field() }}
            <div class="layui-form-item">
              ...
              <div class="layui-form-item">
                ...
                <input type="file" name="images[]" lay-verify="title" multiple  class="layui-input">
                </div>
              </div>
              <div class="layui-form-item">
